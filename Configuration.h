...
//#define STRING_SPLASH_LINE2 WEBSITE_URL         // will be shown during bootup in line 2 this is a waste of resources
...
//#define CUSTOM_MACHINE_NAME "3D Printer" //free - can change if you like

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "00000000-1337-1337-1337-000000000000" //free
 ...
 */
#define MIXING_EXTRUDER // a10m a20m costs 78b links in with adv pause filament runout and nozzle park
 ...
 */
#define POWER_SUPPLY 0 //does not work with the a10+m or a20+m psu
...
#if ENABLED(PIDTEMP)
  //#define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of PROGMEM) this is a waste of resources best to use the console
  //#define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of PROGMEM) this is a waste of resources best to use the console
 ...
 */
//#define DISTINCT_E_FACTORS //only works with non mixing multi extruder setups
 ...
 */
#define S_CURVE_ACCELERATION //costs 274b - smoother moves
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -37    // X offset: -left  +right  [of the nozzle]  -37 = 3dtouch -40 = bltouch 
#define Y_PROBE_OFFSET_FROM_EXTRUDER   0    // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER   0   // Z offset: -below +above  [the nozzle]

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 5 // min probe edge = insets - adjusting this will move both auto and manual probing in from the edge the # in mm for clips ect
...
#define Z_PROBE_SPEED_SLOW 30

// The number of probes to perform at each point.
//   Set to 2 for a fast/slow probe, using the second probe result.
//   Set to 3 or more for slow probes, averaging the results.
//#define MULTIPLE_PROBING 3 // more consistant probe data
...
// Has nothing to do with the real size of the bed this is nothing more then a redefined max travel
#define X_BED_SIZE 230  //a10+m:230 a20+m:255
#define Y_BED_SIZE 230  //a10+m:230 a20+m:255
...
#define Z_MAX_POS 250  //a10+m can go to 260 but safer at 250
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //depends adv pause & nozzle park - works but the resulting print will have messed up layers from stop n start
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION // costs 136b
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET MIN_PROBE_EDGE    // (mm) An inset for corner leveling
 ...
 */
#define SKEW_CORRECTION //costs 26b
 ...
 */
#define NOZZLE_PARK_FEATURE //depends adv pause
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { X_MIN_POS + 5, Y_MIN_POS + 5, (Z_MIN_POS + 5)}
  #define NOZZLE_CLEAN_END_POINT   { X_MAX_POS - 5, Y_MIN_POS + 5, (Z_MIN_POS + 5)}
...
//
#define SPEAKER //if disabled beeper is left uncontrolled and very loud
...
// setting these to 0 will effectivly mute the beeper
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER //a10+m
...
//
//#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER //a20+m costs 329b
